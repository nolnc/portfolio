// Closure library copyright and license
/**
...
// Polyfill Int8Array, Uint8Array, etc. fill
...
// Create y function
function y(a, c) { return a instanceof Function ? a(c) : a }

// Create clamp function
function z(a, c, b) { return Math.max(Math.min(c, b), Math.min(Math.max(c, b), a)) }
...
v("drawLandmarks", function (a, c, b) {
    if (c) {
        ...
        for (var f = c.next();
            !f.done;
            f = c.next())if (f = f.value, void 0 !== f && (void 0 === f.visibility || f.visibility > b.visibilityMin)) {
...
// Define drawConnectors function
...
v("lerp", function (a, c, b, d, e) { return z(d * (1 - (a - c) / (b - c)) + e * (1 - (b - a) / (b - c)), d, e) });